...
//  SpritualTablets
//
//  Created by Veluri Goutham on 25/11/23.
//
...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.sarandatech.spiritualtablets", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.sarandatech.spiritualtablets", account: "userIdentifier").deleteItem()
        } catch {
